...
from utils.general_utils import PILtoTorch, PILtoTorch_objects
import cv2
import os
import pickle
...
class Camera(nn.Module):
    def __init__(self, resolution, colmap_id, R, T, FoVx, FoVy, depth_params, image, invdepthmap,
                 image_name, uid, objects,
                 trans=np.array([0.0, 0.0, 0.0]), scale=1.0, data_device = "cuda",
                 train_test_exp = False, is_test_dataset = False, is_test_view = False,  is_train_view = False 
                 ):
        ...
        self.is_train_view = is_train_view
        ...
        resized_image_objects = PILtoTorch_objects(objects, resolution)
        ...
        self.objects = resized_image_objects.to(self.data_device)
